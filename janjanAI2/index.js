...
if(document.getElementById('janken-area')){   
document.getElementById('janken-area').innerHTML = '
<div class="container"> < h1 > Hello, Janken AI! < /h1> < /div>
< div id = "champion-area" class = "container" >
< p > 最強じゃんけんAI < /p> < div id = "champion-move" > -- - < /div>< /div>
< div id = "challenger-area" class = "container" >
< p > 挑戦者 < /p> < div id = "challenger-move" class = "" > -- - < /div>
< /div>
< div class = "container" >
    < div id = "challenger-button" >
    < button id = "junken-g" type = "button" class = "btn btn-default" > < img class = "move-icon" src = "http://jsrun.it/assets/n/e/E/S/neESG.png" > < /button> 
    < button id = "junken-c" type = "button" class = "btn btn-default" > < img class = "move-icon" src = "http://jsrun.it/assets/2/o/w/F/2owF2.png" > < /button> 
    < button id = "junken-p" type = "button" class = "btn btn-default" > < img class = "move-icon" src = "http://jsrun.it/assets/p/a/O/Y/paOYD.png" > < /button>
< /div> < /div>
< div class = "container" >
