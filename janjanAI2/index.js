...
gButton.addEventListener('click', function(){gameStart(1);}, false);
cButton.addEventListener('click', function(){gameStart(2);}, false);
pButton.addEventListener('click', function(){gameStart(3);}, false);
